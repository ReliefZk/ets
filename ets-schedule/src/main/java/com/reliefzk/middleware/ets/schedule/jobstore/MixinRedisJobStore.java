...
public class MixinRedisJobStore implements JobStore {
    private static final Logger logger = LoggerFactory.getLogger(MixinRedisJobStore.class);
    ...
    protected MixinAbstractRedisStorage storage;

    protected boolean isThisHostWork = true;



    public MixinRedisJobStore setJedisPool(JedisPool jedisPool) {
    ...
    public void initialize(ClassLoadHelper loadHelper, SchedulerSignaler signaler) throws SchedulerConfigException {
        final MixinRedisJobStoreSchema redisSchema = new MixinRedisJobStoreSchema(keyPrefix, keyDelimiter);
        ...
        logger.info("Instantiating JedisPool using host " + host + " and port " + port);
        ...
        storage = new MixinRedisStorage(redisSchema, mapper, signaler, instanceId, lockTimeout);


        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            String ips = jedis.get(ScheduleConstants.SCHEDULE_NOT_WORK_HOST_IP_KEY);
            logger.info("NotWorkIpList: {}", ips);
            ...
            if(StringUtils.contains(ips, hostIp)){
                ...
                isThisHostWork = false;
            } else {
                logger.info("HostIp: {} is not limit, It will do schedule work!", hostIp);
            }
        } finally {
            if (jedis != null) {
                jedis.close();
...
//                @Override
//                public Void doWithLock(Jedis jedis) throws JobPersistenceException {
//                    resumeAll();
//                    return null;
//                }
//            });
...
//        }
    ...
    public void storeJobAndTrigger(final JobDetail newJob, final OperableTrigger newTrigger) throws ObjectAlreadyExistsException, JobPersistenceException {
        try {
            doWithLock(new LockCallbackWithoutResult() {
                @Override
                public Void doWithLock(Jedis jedis) throws JobPersistenceException {
                    storage.storeJob(newJob, true, jedis);
                    storage.storeTrigger(newTrigger, true, jedis);
                    return null;
                }
            });
        } catch (ObjectAlreadyExistsException e) {
    ...
    public boolean removeJob(final JobKey jobKey) throws JobPersistenceException {
        logger.info("remove job: {}", JSON.toJSON(jobKey));
        return doWithLock(new LockCallback<Boolean>() {
            @Override
            public Boolean doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public boolean removeJobs(final List<JobKey> jobKeys) throws JobPersistenceException {
        logger.info("remove job: {}", JSON.toJSON(jobKeys));
        return doWithLock(new LockCallback<Boolean>() {
            @Override
            public Boolean doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public JobDetail retrieveJob(final JobKey jobKey) throws JobPersistenceException {
        logger.info("RetrieveJob: {}", jobKey);
        return doWithLock(new LockCallback<JobDetail>() {
            @Override
            public JobDetail doWithLock(Jedis jedis) throws JobPersistenceException {
                try {
    ...
    public boolean removeTrigger(final TriggerKey triggerKey) throws JobPersistenceException {
        logger.info("remove job: {}", JSON.toJSON(triggerKey));
        return doWithLock(new LockCallback<Boolean>() {
            @Override
            public Boolean doWithLock(Jedis jedis) throws JobPersistenceException {
                try {
    ...
    public boolean removeTriggers(final List<TriggerKey> triggerKeys) throws JobPersistenceException {
        logger.info("remove job: {}", JSON.toJSON(triggerKeys));
        return doWithLock(new LockCallback<Boolean>() {
            @Override
            public Boolean doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public OperableTrigger retrieveTrigger(final TriggerKey triggerKey) throws JobPersistenceException {
        return doWithLock(new LockCallback<OperableTrigger>() {
            @Override
            public OperableTrigger doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public Calendar retrieveCalendar(final String calName) throws JobPersistenceException {
        return doWithLock(new LockCallback<Calendar>() {
            @Override
            public Calendar doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public int getNumberOfJobs() throws JobPersistenceException {
        return  doWithLock(new LockCallback<Integer>() {
            @Override
            public Integer doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public Set<JobKey> getJobKeys(final GroupMatcher<JobKey> matcher) throws JobPersistenceException {
        return doWithLock(new LockCallback<Set<JobKey>>() {
            @Override
            public Set<JobKey> doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public Set<TriggerKey> getTriggerKeys(final GroupMatcher<TriggerKey> matcher) throws JobPersistenceException {
        return doWithLock(new LockCallback<Set<TriggerKey>>() {
            @Override
            public Set<TriggerKey> doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public List<String> getJobGroupNames() throws JobPersistenceException {
        return doWithLock(new LockCallback<List<String>>() {
            @Override
            public List<String> doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public List<OperableTrigger> getTriggersForJob(final JobKey jobKey) throws JobPersistenceException {
        return doWithLock(new LockCallback<List<OperableTrigger>>() {
            @Override
            public List<OperableTrigger> doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public Trigger.TriggerState getTriggerState(final TriggerKey triggerKey) throws JobPersistenceException {
        return doWithLock(new LockCallback<Trigger.TriggerState>() {
            @Override
            public Trigger.TriggerState doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public Collection<String> pauseTriggers(final GroupMatcher<TriggerKey> matcher) throws JobPersistenceException {
        return doWithLock(new LockCallback<Collection<String>>() {
            @Override
            public Collection<String> doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public Set<String> getPausedTriggerGroups() throws JobPersistenceException {
        return doWithLock(new LockCallback<Set<String>>() {
            @Override
            public Set<String> doWithLock(Jedis jedis) throws JobPersistenceException {
    ...
    public List<OperableTrigger> acquireNextTriggers(final long noLaterThan, final int maxCount, final long timeWindow) throws JobPersistenceException {
        if(!isThisHostWork){
            logger.info("CurrentHostWorkState: {}, Can't acquireNextTriggers", isThisHostWork);
            return null;
        }
        logger.info("noLaterThan: {}, maxCount: {}, timeWindow: {}", new Object[]{noLaterThan, maxCount, timeWindow});
        return doWithLock(new LockCallback<List<OperableTrigger>>() {
            @Override
            public List<OperableTrigger> doWithLock(Jedis jedis) throws JobPersistenceException {
                try {
    ...
    public List<TriggerFiredResult> triggersFired(final List<OperableTrigger> triggers) throws JobPersistenceException {
        return doWithLock(new LockCallback<List<TriggerFiredResult>>() {
            @Override
            public List<TriggerFiredResult> doWithLock(Jedis jedis) throws JobPersistenceException {
                try {
    ...
    private interface LockCallback<T> {
        T doWithLock(Jedis jedis) throws JobPersistenceException;
    }
