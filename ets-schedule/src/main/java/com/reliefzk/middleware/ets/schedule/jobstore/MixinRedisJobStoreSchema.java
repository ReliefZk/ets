 ...
 * 7/14/2014
 */
public class MixinRedisJobStoreSchema {
    ...
    public MixinRedisJobStoreSchema(){
        this("");
    }
     ...
     */
    public MixinRedisJobStoreSchema(String prefix){
     ...
     */
    public MixinRedisJobStoreSchema(String prefix, String delimiter) {
        this.prefix = prefix;
     ...
     */
    public String triggerStateKey(final MixinRedisTriggerState state){
